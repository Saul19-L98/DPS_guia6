        ...
        <Modal transparent = { true } animationType = 'slide' visible = { modalVisiblePlaya } onRequestClose = { () => { alert('Modal has been closed.') }}>
          <View style = { styles.vistaModal }>
            <View style = { styles.Modal }>
              ...
              <Text>El Salvador cuenta con hermosas plaras a nivel Centroamérica</Text>
        ...
        <View style = { styles.contenedor }>
          ...
          <ScrollView horizontal>
            ...
            <View>
              <Image 
                style = { styles.ciudad }
                source = { require('./src/img/actividad2.jpeg') }
              />
            </View>
            <View>
              <Image 
                style = { styles.ciudad }
                source = { require('./src/img/actividad3.jpeg') }
              />
            </View>
            <View>
              <Image 
                style = { styles.ciudad }
                source = { require('./src/img/actividad4.jpeg') }
              />
            </View>
            <View>
              <Image 
          ...
          <View>
            ...
            <View>
              <Image 
                style = { styles.mejores }
                source = { require('./src/img/tamales.jpg') }
              />
            </View>
            <View>
              <Image 
